...
df_ko.to_csv("data/inndata_tromso_ko.csv", sep=";", decimal=",", index=False, encoding="utf-8-sig")
...
df_reiser.to_csv("data/inndata_tromso_reiser.csv", sep=";", decimal=",", index=False, encoding="utf-8-sig")
...
df_nokkel.to_csv("data/inndata_tromso_nokkel.csv", sep=";", decimal=",", index=False, encoding="utf-8-sig")
