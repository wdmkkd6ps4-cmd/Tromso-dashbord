...
def main():
    print("Laster kødata...")
    ko_data = load_and_process_ko_data("data/inndata_tromso_ko.csv")
    print(f"  - {{len(ko_data)}} rader")

    print("\\nLaster reisedata...")
    reiser_data = load_and_process_reiser_data("data/inndata_tromso_reiser.csv")
    print(f"  - {{len(reiser_data)}} rader")

    print("\\nLaster nøkkeltalldata...")
    nokkel_df = load_and_process_nokkel_data("data/inndata_tromso_nokkel.csv")
